...
<body class="w3-light-grey">
    ...
    <div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
        ...
        <span class="w3-bar-item w3-right">Glamour Glossary Admin</span>
    </div>
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        <div class="w3-container w3-row">
            <div class="w3-col s4">
                <img src="https://img.freepik.com/vecteurs-premium/icone-profil-personnes_24877-40756.jpg" class="w3-circle w3-margin-right" style="width:46px">
            </div>
...
if(isset($_POST["add_item"])){ //check if form was submitted
    ...
    $pro_img2 = $_POST['pic2'];
    $pro_img3 = $_POST['pic3'];
    $sql = "INSERT INTO products VALUES(default, $pro_cat, '$pro_name', '$imgloc1', '$imgloc2', '$imgloc3', $pro_price, '$pro_details', $pro_quant)";
    if ($conn->query($sql) === TRUE) {
