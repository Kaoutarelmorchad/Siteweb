    ...
    <div style="margin: 2%;" class="chrow">
                ...
                <form action="" method="POST">
                    <div class="chrow">
                        ...
                        <div class="col-50">
                            ...
                            <input type="text" id="cname" name="cardname" placeholder="El morchad kaoutar">
                            <label for="ccnum">Credit card number</label>
                            <input type="text" id="ccnum" name="cardnumber" placeholder="1111-2222-3333-4444">
                            <label for="expmonth">Exp Month</label>
                            <input type="text" id="expmonth" name="expmonth" placeholder="Novembre">
                            <div class="chrow">
                                <div class="col-50">
        ...
        <?php
                ...
                if(isset($_POST["place_order"]))
                {
                    ...
                    $sql2 = "UPDATE cart SET ordered = 1, order_id = $max_oid WHERE  ordered = 0";
        ...
        <div class="col-25">
            ...
            <h4>Cart <span class="checkprice" style="color:black"><i class="fa fa-shopping-cart"></i> <b></b></span></h4>                        
                <?php
                            ...
                            if($cust_id != 0)
                            {
                                            $sql = "SELECT p.pro_id, p.pro_name, p.pro_price, c.quantity FROM products p
                                            ...
                                            if ($result->num_rows > 0) {
                                                    while($row = $result->fetch_assoc()) {
                                                        $p_price = $row["pro_price"] * $row["quantity"];
                                                        $t_price += $p_price;
                                                       echo '<p><a href="product.php?'. $row["pro_id"] .'">'. $row["pro_name"] .'</a> <span class="checkprice"> MAD '. $p_price .'</span></p>';
                                                    }
                                            }
                            }
                ?>
                ...
                <hr>
                <p>Total <span class="price" style="color:black"><b>MAD<?php echo $t_price; ?></b></span></p>
            </div>
        </div>
    </div>
