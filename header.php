...
<head>
   ...
   Glamour Glossary
    ...
    <div class="topnav" id="myTopnav" style="box-shadow: 0 0.0rem 0.2rem #ddd;">
        ...
        <div class="logo">
            <a href="index.php" style="float: none;">   Glamour Glossary
            </a>
        </div>
...
window.onclick = function(event) {
  if (event.target == modal) {
    ...
    <a href="index.php" class="mtext">Home</a>
        <div class="dropdown">
            <button class="dropbtn mtext" onclick="dropbtn()">New Collection
          </button>
            <div class="dropdown-content" id="dropdown-content">
                ...
                <div class="row">
                    <div class="column">
                        <h3>Noel Collection</h3>
                
                        <a href="noel.php">Gifts for Her</a>
        ...
        <a href="offre.php?q=winter" class="mtext">Offres</a>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" id="dropdown-content">
                ...
                <div class="row">
                    <div class="column">
                        <h3>LipStick</h3>
                        <a href="kikolipstick.php">Kiko</a>
                        <a href="kylielipstick.php">Kylie</a>
                        <a href="diorlipstick.php">Dior</a>
                    </div>
                    <div class="column">
                        <h3>Gloss</h3>
                        <a href="kikogloss.php">Kiko</a>
                        <a href="kyliegloss.php">Kylie</a>
                        <a href="diorgloss.php">Dior</a>
                    </div>
                    <div class="column">
                        <h3>Lip Liner</h3>
                        <a href="kikoliner.php">Kiko</a>
                        <a href="kylieliner.php">Kylie</a>
                        <a href="diorliner.php">Dior</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="dropdown">
            <button class="dropbtn mtext" onclick="dropbtn()">Best Sellers
          </button>
            <div class="dropdown-content" id="dropdown-content">
                <div class="header">
                    <h2>BEST OF YEAR</h2>
                ...
                <div class="row">
                    ...
                    <div class="column">
                        <h3>Best Sellers</h3>
                        <a href="bestkiko.php">Kiko</a>
                        <a href="bestkylie.php">Kylie</a>
                        <a href="bestdior.php">Dior</a>
                    </div>
                </div>
            </div>
        </div>
