...
<div class="card-container">
    ...
    <?php
    $sql = "SELECT pro_id, pro_name, pro_price, pro_img,offre FROM products WHERE pro_id=64 or pro_id=65 or pro_id=66 or pro_id=67 or pro_id=68 ";
            ...
            echo '<div class="card searchcard">
                    <form method="post" action="">
                        ...
                        <a href="product.php?' . $row["pro_id"] . '">
                            ...
                            <h3>' . $row["pro_name"] . '</h3>
                            <p class="price" style = "text-decoration: line-through;">' . $row["offre"] . ' MAD</p>
